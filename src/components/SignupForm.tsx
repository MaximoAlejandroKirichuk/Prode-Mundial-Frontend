...
export function SignupForm() {
  ...
  function validate(): SignupFormErrors {
    ...
    if (!formData.confirmEmail.trim()) {
      errs.confirmEmail = "Confirmá tu correo.";
    } else if (
      formData.email.trim() &&
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        <CardTitle className="text-2xl">Sumate al Prode</CardTitle>
        <CardDescription>
          Completá tus datos y empezá a predecir los resultados
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          ...
          <p className="text-xs text-center text-muted-foreground mt-1">
            Al inscribirte, aceptás participar del Prode Mundial.
          </p>
        </form>
      </CardContent>
    </Card>
